...
class GameCanvasForBot extends PentPanel implements ActionListener {
	...
	public GameCanvasForBot(int W, int H,  Font f, int s) {
		super(0, 0, W, H, f, s);
...
//		for(int i=0; i<psblMoves.getXList().size(); i++) {System.out.println(psblMoves.getXList());}
		...
		checkShape.printShape();
		System.out.println("****active Shape");
		activeShape.printShape();
		System.out.println("OptimalX: "+bestFit.getOptimalX());
		if(y<5) {
