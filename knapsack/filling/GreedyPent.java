...
//	     // Place everything into the parcel array
	...
	private static PentominoParcel[] createAr() {
...
//	     // Place everything into the parcel array
	...
	* @param numT  The number of the T parcels to be used
	...
	public static Truck greedy() {
		return greedy(createAr(), 0);
	}

	/* The same algorithm as before. It works if there is no restriction in the number of parcels*/
	public static Truck greedy(PentominoParcel[] parcelAr,int index) {
		int totVal=0;
		Truck truck = new Truck();
		...
		ArrayList<PentominoParcel> parcelListT = new ArrayList<>();
		ArrayList<PentominoParcel> parcelList = new ArrayList<>();
